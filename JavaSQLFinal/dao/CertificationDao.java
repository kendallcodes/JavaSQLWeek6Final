...
public class CertificationDao {
	...
	private final String CREATE_NEW_CERT_QUERY = "INSERT INTO certification(cert_status) VALUES (?)";
	private final String UPDATE_CERT_QUERY = "UPDATE certification SET cert_status = ? WHERE cert_id = ?";
	...
	public
	void addNewCert (String certStatus, String certDate) throws SQLException { 
